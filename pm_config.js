...
window.PM_CONFIG = {
  ...
  // al usuario de USERS.
  VENCEN: {
    // (vacío = nadie con fecha de corte; Carolina Rivera pasó a acceso
    //  permanente el 08-09-2026, antes vencía el 20-ago)
  },
  ...
  USERS: {
    ...
    // Monserrat Rivera · biomédica (apoyo Puesta en Marcha)
    ...
    // Carolina Rivera · arquitecta — acceso permanente (08-09-2026) y editora
    // del Atlas (asignar funcionarios a recintos y corregir nombres de recinto)
    ...
    // (AIF · MOP). Contraparte de FISCALIZACIÓN,
